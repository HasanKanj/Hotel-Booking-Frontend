...
// get user ads wishlist
export const GetUserAdWishlist = createAsyncThunk(
  '/wishlist',
  async ( ThunkAPI) => {
    try {
    ...
    builder
      ...
      .addCase(login.rejected, (state, actions) => {
        ...
        state.errorMessage = actions.payload
            ...
            // get wishlist
            .addCase(GetUserAdWishlist.pending, (state) => {
              state.isLoading = true
              state.user = null
              state.isSuccess = false
              state.isError = false
            ...
            .addCase(GetUserAdWishlist.fulfilled, (state, actions) => {
              state.user = actions.payload.user
              state.isSuccess = true
              state.isLoading = false
              state.isError = false
            ...
            .addCase(GetUserAdWishlist.rejected, (state, actions) => {
              state.user = null
              state.isSuccess = false
              state.isLoading = false
              state.isError = true
