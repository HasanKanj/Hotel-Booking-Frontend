          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="text-blue-700 mb-4 block text-base font-semibold">
                  Contact Us
                </span>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-blue-700 text-base">
                      <a
                        href="https://www.google.com/maps/place/Beirut+Tayouneh+Lebanon"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Beirut Tayouneh Lebanon
                      </a>
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base text-blue-700">
                      <a href="tel:+96171900468">(+961) 71900468</a>
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form ref={form} onSubmit={onSubmit} className="mt-14">
                  <div className="mb-6">
                    <input
                      type="text"
