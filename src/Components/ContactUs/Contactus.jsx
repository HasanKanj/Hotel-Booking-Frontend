  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">Fell free to contact us</p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
            <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium text-gray-900">+961 71 900 468</p>
                    </div>
                </div>
                ...
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium text-gray-900">Hasankanj4@gmail.com</p>
                    </div>
                </div>
                ...
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">Badaro Prest, LEBANON</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-6 overflow-hidden bg-white rounded-xl">
                <div className="px-6 py-12 sm:p-12">
                    <h3 className="text-3xl font-semibold text-center text-gray-900 py-4">Send us a message</h3>
